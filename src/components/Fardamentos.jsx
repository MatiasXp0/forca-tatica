...
const Fardamentos = ({ isAdmin }) => {
  ...
  return (
    <div className="fade-in w-full max-w-full overflow-x-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 xl:gap-10 h-auto lg:h-[calc(100vh-180px)]">
        
        {/* === COLUNA ESQUERDA - CATÁLOGO (SCROLL PRÓPRIO) === */}
        <div className="w-full lg:w-7/12 xl:w-8/12 h-auto lg:h-full overflow-y-auto">
        ...
        <div className="w-full lg:w-6/12 xl:w-5/12 h-auto lg:h-full overflow-y-auto">
